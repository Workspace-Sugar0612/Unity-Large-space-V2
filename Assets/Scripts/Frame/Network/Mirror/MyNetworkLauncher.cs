...
public class MyNetworkLauncher : MonoBehaviour
{
    public bool alwaysAutoStart = false;
    readonly Dictionary<long, ServerResponse> discoveredServers = new Dictionary<long, ServerResponse>();
    private MyNetworkDiscovery _vrNetworkDiscovery;
    private Log _log;
    ...
    void Start()
    {
        if (_vrNetworkDiscovery == null) 
            _vrNetworkDiscovery = (MyNetworkDiscovery)FindObjectOfType(typeof(MyNetworkDiscovery));
