...
{
    private MyNetworkLauncher _luncher;
    ...
    protected override ServerResponse ProcessRequest(ServerRequest request, IPEndPoint endpoint) 
    {
        ...
        try
        {
            // this is an example reply message,  return your own /这是一个回复消息的例子，返回你自己的
            // to include whatever is relevant for your game / 添加与游戏相关的内容
